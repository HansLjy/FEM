...
namespace {
  const bool treetrunk_registered = ObjectFactory::Instance()->Register("affine-decomposed-treetrunk", [](const json& config) {return new AffineDecomposedTreeTrunk(config);});
}
