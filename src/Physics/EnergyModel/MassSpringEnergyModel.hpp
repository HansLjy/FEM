...
template<class Data>
double MassSpringEnergyModel::GetPotential(const Data *data, const Ref<const VectorXd> &x) const {
...
template<class Data>
VectorXd MassSpringEnergyModel::GetPotentialGradient(const Data* data, const Ref<const VectorXd> &x) const {
	const int num_edges = data->_num_edges;
	const double stiffness = data->_stiffness;
	const MatrixXi& edge_topo = data->_edge_topo;
	const VectorXd& rest_length = data->_rest_length;
...
template<class Data>
void MassSpringEnergyModel::GetPotentialHessian(const Data* data, const Ref<const VectorXd> &x, COO &coo, int x_offset, int y_offset) const {
	const int num_edges = data->_num_edges;
	const double stiffness = data->_stiffness;
	const MatrixXi& edge_topo = data->_edge_topo;
	const VectorXd& rest_length = data->_rest_length;
