...
// Generated by matlab
void DistanceMediumHessian(double A, double B, double C, double D, double E, double,
                     double hessian[36]) {
    double t11;
    double t2;
    double t21;
...
// Generated by matlab
void DistanceMediumGradient(double A, double B, double C, double D, double E, double,
                            double gradient[6]) {
    double t11;
    double t12;
    double t14;
...
Vector12d GetVPDistanceGradient(const Vector3d &vertex, const Vector3d &face1, const Vector3d &face2, const Vector3d &face3) {
    ...
    double pspy[6];
    DistanceMediumGradient(A, B, C, D, E, F, pspy);
...
Matrix12d GetVPDistanceHessian(const Vector3d &vertex, const Vector3d &face1, const Vector3d &face2, const Vector3d &face3) {
    ...
    Matrix6d p2spy2;
    DistanceMediumHessian(A, B, C, D, E, F, p2spy2.data());
