...
// Generated by matlab
void VPMediumDistanceHessian(double A, double B, double C, double D, double E, double,
                     double hessian[36]) {
    double t11;
    double t2;
    double t21;
...
// Generated by matlab
void VPMediumDistanceGradient(double A, double B, double C, double D, double E, double,
                            double gradient[6]) {
    double t11;
    double t12;
    double t14;
...
Vector12d GetVPDistanceGradient(const Vector3d &vertex, const Vector3d &face1, const Vector3d &face2, const Vector3d &face3) {
    ...
    double pspy[6];
    VPMediumDistanceGradient(A, B, C, D, E, F, pspy);
...
Matrix12d GetVPDistanceHessian(const Vector3d &vertex, const Vector3d &face1, const Vector3d &face2, const Vector3d &face3) {
    ...
    Matrix6d p2spy2;
    VPMediumDistanceHessian(A, B, C, D, E, F, p2spy2.data());
...
void MediumEEDistanceGradient(double A, double B, double C, double D, double E,
                        double, double gradient[6]) {
	double b_t14_tmp;
	double t12_tmp;
	double t13;
	double t14;
	...
	double t9;
	// EEDistanceGradient
	//     GRADIENT = EEDistanceGradient(A,B,C,D,E,F)
	//     This function was generated by the Symbolic Math Toolbox version 9.2.
	//     05-Jan-2023 18:03:32
	t2 = B * B;
	t5 = A * C;
	t8 = t5 * 3.0;
	t9 = E * B * B * B;
	...
	t13 = A * D * (C * C);
	t14_tmp = C * D;
	b_t14_tmp = t14_tmp * t2;
	t14 = b_t14_tmp * 5.0;
	t16 = A * E - B * D;
	t17 = t2 - t5;
	t18 = 1.0 / (t17 * t17);
	t19 = 1.0 / (t17 * t17 * t17);
	t17 = t9 + t12_tmp * t5 * 7.0;
	gradient[0] = t19 * (t12_tmp - t14_tmp) * ((t17 + t13) - b_t14_tmp * 9.0);
	gradient[1] = t16 * t19 * ((t17 - t13 * 3.0) - t14) * -2.0;
	gradient[2] = t16 * t16 * t19 * (t2 * 5.0 + t8);
	gradient[3] = t18 * (((t9 + t13) - t14) + t12_tmp * t8) * -2.0;
	gradient[4] = t16 * t18 * (t2 + t8) * 2.0;
	gradient[5] = 1.0;
}
...
Vector12d GetLLDistanceGradient(const Vector3d& edge11, const Vector3d& edge12, const Vector3d& edge21, const Vector3d& edge22) {
    ...
    double pspy[6];
    MediumEEDistanceGradient(A, B, C, D, E, F, pspy);
...
void MediumEEDistanceHessian(double A, double B, double C, double D, double E, double, double hessian[36]) {
	double b_t80_tmp;
	double b_t81_tmp;
	double t10;
	double t11;
	...
	double t9;
	// EEDistanceHessian
	//     HESSIAN = EEDistanceHessian(A,B,C,D,E,F)
	//     This function was generated by the Symbolic Math Toolbox version 9.2.
	//     05-Jan-2023 18:03:32
	t2 = A * A;
	t3 = B * B;
	...
	t48 = 1.0 / (t48 * t48 * t48);
	t60 = t58 * t58;
	t70 = A * t38 * t53 * t48 * 2.0;
	t80_tmp = t4 * t12;
	t80_tmp_tmp = D * t3;
	b_t80_tmp = t80_tmp_tmp * t11;
	t80 = t48 * ((((t16 - t80_tmp * 2.0) + b_t80_tmp * 12.0) + t49) + t54) * 2.0;
	t81_tmp = C * D;
	b_t81_tmp = E * t2 * t7;
	t81 = t48 *
		((((E * t5 - t81_tmp * t4 * 10.0) - A * t7 * t13 * 6.0) +
			E * t3 * t11 * 12.0) +
			b_t81_tmp * 3.0) *
		2.0;
	t66 = -(B * t37 * t58 * 2.0);
	t72_tmp = B * t38;
	t72 = -(t72_tmp * t53 * t48 * 2.0);
	t75_tmp = t81_tmp * t3;
	t75 = B * t48 * (((t17 + t24) + t31) + t75_tmp * -5.0) * 2.0;
	t53 = t75_tmp * 9.0;
	t77 = -(C * t48 * (((t22 + t24_tmp * t14) + t25) - t53) * 2.0);
	t22 += t24;
	t24 = t72_tmp * t60 * ((t22 + t31) - t53) * 2.0;
	t53 = t38 * t60 *
		((((t16 * 5.0 - t80_tmp * 10.0) + b_t80_tmp * 16.0) + t49) + t54) * 2.0;
	t14 = D * E;
	t48 = -(t60 *
			(((((((t6 * t10 + A * B * t8 * t9 * 6.0) - C * E * t16 * 15.0) +
				t4 * t10 * t11 * 16.0) -
				t14 * t2 * t8 * 3.0) +
				t4 * t7 * t9 * 18.0) +
			B * t2 * t7 * t10 * 7.0) -
			t80_tmp_tmp * t7 * t12 * 30.0) *
			2.0);
	hessian[0] =
		C * t60 * (t24_tmp - t81_tmp) * ((t22 + t25) - t75_tmp * 13.0) * 2.0;
	hessian[1] = t48;
	hessian[2] = t24;
	hessian[3] = t77;
	hessian[4] = t75;
	...
	hessian[7] =
		t60 *
		((((((((t14 * t6 * -2.0 + A * t5 * t10 * 3.0) + C * t5 * t9 * 15.0) -
			D * t11 * t17 * 52.0) +
			t2 * t8 * t9 * 3.0) +
			(A * A * A) * t7 * t10 * 7.0) -
			b_t81_tmp * t13 * 42.0) +
	...
	hessian[12] = t24;
	hessian[13] = t53;
	hessian[14] = A * (t38 * t38) * t60 * (t3 * 3.0 + t11) * 6.0;
	hessian[15] = t72;
	hessian[16] = t70;
	hessian[17] = 0.0;
	hessian[18] = t77;
...
Matrix12d GetLLDistanceHessian(const Vector3d &edge11, const Vector3d &edge12, const Vector3d &edge21, const Vector3d &edge22) {
    ...
    Matrix6d p2spy2;
    MediumEEDistanceHessian(A, B, C, D, E, F, p2spy2.data());
