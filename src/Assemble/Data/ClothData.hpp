...
struct ClothData : public SampledObjectData {
     ...
     */
    ClothData(double rho, double thickness, double k_stretch, double k_shear, double k_bend_max, double k_bend_min, const Vector2d& max_dir,
    ...
    ClothData(double rho, double thickness, double k_stretch, double k_shear, double k_bend_max, double k_bend_min, const Vector2d& max_bend_dir,
	...
	static VectorXd GenerateUVCoord(const Eigen::Vector3d &start, const Eigen::Vector3d &u_end, const Eigen::Vector3d &v_end, int num_u_segments, int num_v_segments);
